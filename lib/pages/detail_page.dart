...
import 'package:keep_travel/cubit/app_cubit_states.dart';
import 'package:keep_travel/cubit/app_cubits.dart';
import 'package:keep_travel/misc/colors.dart';
import 'package:keep_travel/widgets/app_buttons.dart';
...
class _DetailPageState extends State<DetailPage> {
  int gottenStars = 4, selectedIndex = 1;
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Wrap(
                            children: [
                              for (int i = 0; i < 5; i++)
                                Icon(
                                  Icons.star,
                                  color: i < detail.place.stars.toInt()
                                      ? AppColors.starColor
                      ...
                      Wrap(
                        children: [
                          for (int i = 0; i < detail.place.people.toInt(); i++)
                            InkWell(
                              onTap: () {
                                setState(() {
                                  selectedIndex = i + 1;
                              ...
                              child: Container(
                                ...
                                child: AppButton(
                                  color: selectedIndex == i + 1
                                      ? Colors.white
                                      : Colors.black,
                                  backgroundColor: selectedIndex == i + 1
                                      ? Colors.black
                                      : AppColors.buttonBackground,
                                  borderColor: selectedIndex == i + 1
                                      ? Colors.black
                                      : AppColors.buttonBackground,
                                  size: 50,
                                  isIcon: false,
